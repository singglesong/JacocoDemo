...
/**
 * This example reads Java class files, directories or JARs given as program arguments and dumps information about the classes.
 * 这个示例读取作为程序参数提供的Java类文件、目录或jar，并转储有关类的信息
 */
